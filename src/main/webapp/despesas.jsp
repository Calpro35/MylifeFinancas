...
<div class="container dashboard-container border pt-5 mt-2">
  <div class="row w-100">
    ...
    <div class="dashboard-content col-9">
      ...
      <!-- segue a mesma logica de investimentos -->
      <h4 class="text-secondary mt-4 pt-3 mb-5">Despesas</h4>

      <p class="fs-6 container-fluid bg-light me-3 mt-3 ">Lista de todas as suas Despesas</p>
        ...
        <tr class="table-row">
          ...
          <td class="text-danger text-center">
            <button type="button"
                    ...
                    onclick="codigoExcluir.value = ${despesa.cd_servico}"
            >
      ...
      <div class="d-flex gap-2 mt-5">
        <p>Total: R$</p>
        <span class="text-success">${totalDespesas}</span>
      </div>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h5>Tem certeza que deseja excluir a Despesa?</h5>
